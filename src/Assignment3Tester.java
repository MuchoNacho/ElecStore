public class Assignment3Tester {
    public static void main(String[] args){
        ...
        System.out.println("# matched products (should be 3): " + store.searchProducts("red", 55, 100).size());
        System.out.println("# matched products (should be 5): " + store.searchProducts("SSD", 55, 100).size());
        System.out.println("# matched products (should be 8): " + store.searchProducts("ram", 55, 100).size());
